...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <form class="form-search" action="/index.php/Admin/Product/index" method="post">
                <span class="select-box">产品类型名称:
                    <input type="text" class="input-medium typename" name="typename" placeholder="请输入类型名称" style="width: 100px;"/ >
                </span>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th>八级滤芯</th>
                    <th>创建时间</th>
                    <?php if($_SESSION['adminuser']['leavel'] < 1): ?><th>操作</th><?php endif; ?>
                ...
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td><?php echo ($vo["filter1"]); ?></td>
                            <td><?php echo ($vo["filter2"]); ?></td>
                            <td><?php echo ($vo["filter3"]); ?></td>
                            <td><?php echo ($vo["filter4"]); ?></td>
                            <td><?php echo ($vo["filter5"]); ?></td>
                            <td><?php echo ($vo["filter6"]); ?></td>
                            <td><?php echo ($vo["filter7"]); ?></td>
                            <td><?php echo ($vo["filter8"]); ?></td>
                            <td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
                        <?php if($_SESSION['adminuser']['leavel'] < 1): ?><td><a href="<?php echo U('Admin/product/edit',array('id'=>$vo['id']));?>">编辑</a></td><?php endif; ?>
