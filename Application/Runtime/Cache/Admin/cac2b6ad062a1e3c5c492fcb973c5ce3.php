...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <form class="form-search" action="/index.php/Admin/Users/flow" method="get">
                ...
                <span class="select-box" style="display: inline-block;position:relative">充值时间:
                    <input type="text" value="<?php echo I('get.minaddtime');?>" id="date-start" class="input-medium form-control" name="minaddtime" placeholder="请选择时间" style="width: 76px;left: 0"/ > ~
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td><?php echo ($vo['flow']*$vo['num']); ?></td>
                        <td><?php echo ($vo["reday"]); ?></td>
                        <td>
                            <?php switch($vo["mode"]): case "0": ?>系统赠送<?php break;?>
                ...
                $('.pagination ul span').wrap('<li class="active"></li>')
                 ...
                 /**************** 搜索关键字保留 -- 开始 ******************/
                    ...
                    $('button[type="reset"]').click(function(){
                        location.href = '<?php echo U("Admin/Users/flow");?>';
