...
$(function(){
    ...
    $.ajax({
        url:'/index.php/Admin/Index/deviceDetail?code=' + location.hash.slice(1),
        type:'get',
        error:function(err){
            //console.log('err',err)
        },
