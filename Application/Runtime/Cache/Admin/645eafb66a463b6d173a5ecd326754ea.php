...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <form class="form-search" action="/index.php/Admin/Personnel/index" method="post">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <a href="/index.php/Admin/Personnel/edit/id/<?php echo ($vo["id"]); ?>">编辑</a>
                            <a href="javascript:void(0)" url="/index.php/Admin/Personnel/del/id/<?php echo ($vo["id"]); ?>" class="_del">删除</a>
                        </td>
