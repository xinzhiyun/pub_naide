...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <form class="form-search" action="/index.php/Admin/Feeds/feedslist" method="post">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <!-- <a href="javascript:void(0)" url="/index.php/Admin/Feeds/feedsdel/id/<?php echo ($vo["id"]); ?>" class="_del">删除</a> -->
            ...
            <script>
                ...
                $('._del').click(function(){
                    ...
                    tip('确定删除？','提示',function(){
                        window.location.href = "/index.php/Admin/Feeds/feedsdel?id="+a;
                    })
                    return false;
                })
                ...
                /**************** 搜索关键字保留 -- 开始 ******************/
                    ...
                    $('button[type="reset"]').click(function(){
                        location.href = '<?php echo U("Admin/Feeds/feedslist");?>';
