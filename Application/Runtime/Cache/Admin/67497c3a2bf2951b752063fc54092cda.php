...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <form class="form-search" action="/index.php/Admin/Users/index" method="post">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td><a href="/index.php/Admin/Users/user_info?open_id=<?php echo ($vo["open_id"]); ?>"><?php echo ($vo["nickname"]); ?></a></td>
