...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            <div class="titleBar">产品管理/<span>产品类型设置</span></div>
            <div class="formBox">
                <form class="form-horizontal " action="/index.php/Admin/Product/add" method="post" id="_formTable">
                    <div class="groupBox control-group">
                        <span>类型名称<sub style="color:red;margin-left: 5px;">*</sub></span>
                        <input type="text" class="control" name="typename" placeholder="请输入类型名称" style="width:210px;">
                    </div>
                    <div class="groupBox control-group">
                        <span>请设置滤芯</span>
                        <input type="text" class="control selects" placeholder="请选择滤芯" />
                        <div class="selectList">
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><p><?php echo ($vo["filtername"]); ?>-<?php echo ($vo["alias"]); ?></p><?php endforeach; endif; ?>
                        </div>
                    </div>
                    <div class="groupBox control-group">
