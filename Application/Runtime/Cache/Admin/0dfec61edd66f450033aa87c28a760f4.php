    ...
    <!-- bootstrap.js -->
		...
		*{
		...
		body{
			...
			width:100%;
			/*height:100%;*/
			background: url(/Public/Admin/img/login.jpg) no-repeat;
		...
		/*.loginleft{
			...
			margin-top:200px;
			position:relative;
			background: url(/Public/Admin/img/showBg.png) no-repeat 70px bottom;
		}*/
		a,button{ 
		outline:none;
		}
		...
		.control-group .span1{
			background:url(/Public/Admin/img/adminlogo.jpg) no-repeat center center;
			background-size:45%;
		}
		.control-group .span2{
			background:url(/Public/Admin/img/psdlogo.jpg) no-repeat center center;
			background-size:45%;
		}
		.control-group input{
			float:right;
...
<body>
    ...
    <div class="" id="login">
		<!-- <div class="loginleft">
			<img class="logo3" src="/Public/Admin/img/fullwaters.png"/>
			<img class="logo2" src="/Public/Admin/img/washlogo.png"/>
			<img class="logo1" src="/Public/Admin/img/addwater.png"/>
		</div> -->
        <div class="loginBox">
            <form class="form-horizontal" action="" method="post" >
                ...
                <div class="control-group" style="box-shadow:none;border:0">
                        <span class="inputBox"><input type="text" name="code" class="verifyBox" placeholder="验证码"></span><img src="/index.php/Admin/Login/yzm" onclick="this.src='/index.php/Admin/Login/yzm?id=' + Math.random()">
                </div> 
                <div>  
