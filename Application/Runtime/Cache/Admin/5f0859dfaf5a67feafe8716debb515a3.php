...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <form class="form-search" action="/index.php/Admin/Feeds/repairlist" method="post">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td onclick='showImg(this)' data-src="/Public<?php echo ($vo["picpath"]); ?>"><img width="40" src="/Public<?php echo ($vo["picpath"]); ?>" alt=""></td>
                            <td><?php echo ($vo["address"]); ?></td>
                            <td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
                            <td>
                                <?php switch($vo["status"]): case "0": ?>待处理<?php break;?>
                                    <?php case "1": ?>已处理完成<?php break;?>
                                    <?php case "2": ?>正在处理中<?php break;?>
                                    <?php case "3": ?>任务进行中<?php break;?>
                                    <?php default: endswitch;?>
                            </td>
                            <td>
                                <?php switch($vo["status"]): case "0": ?><a href="<?php echo U('Work/add',['id'=>$vo['id']]);?>">生成工单</a><?php break;?>
                                    <?php default: endswitch;?>
                            </td>
            ...
            <script>
                ...
                /**************** 搜索关键字保留 -- 开始 ******************/
                    ...
                    $('button[type="reset"]').click(function(){
                        location.href = '<?php echo U("Admin/Feeds/repairlist");?>';
